...
// TODO: do not hardcode functionType
router.post('/contract/:name/:functionType/:methodName', async ctx => {
    console.log('JANE CALL 1');
    const body = ctx.request.body;
    // TODO: unhardcode
    const a = {
        "a": 1,
    ...
    serializedArgs =  Array.from(BSON.serialize(a));
    ...
    const params2 = [{
        ...
        method_name: 'sum_with_input',
        args: [10, 0, 0, 0, 30, 0, 0, 0]
    }];
    ...
    const response = await client.request('call_view_function', params);
    console.log('JANE CALL 3');
