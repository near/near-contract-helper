...
Note that you need to add an `ACCOUNT_CREATOR_KEY` to your `.env`. Running `nearcore` locally created a `~/.near/validator_keys.json` file for you. Copy the contents of this file and paste them as a single line for the `*_KEY` value in your `.env`.
